...
!#endif
    ...
    +(npart1+8+npart2+4*nn)+(npart1+12+npart2+4*nn)+(npart1+13+npart2+4*nn)+(npart1+13+npart2+4*nn) &
    +(npart1+6+npart2+4*nn)+(npart1+6+npart2+4*nn),convert='big_endian')
    write (77,rec=1) &
    header(1:nheader), &
    ...
    part1(1:npart1)//'precip'//part2(1:npart2),sngl(precip(1:nn)), &
    part1(1:npart1)//'uplift'//part2(1:npart2),sngl(u(1:nn))
    close(77)
    !part1(1:npart1)//'HHHHH'//part2(1:npart2),sngl(f(1:nn)), &    
    !part1(1:npart1)//'sedthick'//part2(1:npart2),sngl(h(1:nn)-b(1:nn)), &
